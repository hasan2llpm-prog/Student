/* =========================================================
   Student Firebase Messaging Service Worker
   Offline shell + runtime cache + Firebase Cloud Messaging
========================================================= */

const CACHE_VERSION = "student-v8.5.0";
...
const APP_SHELL = [
    ...
    "./student-ai.js",
    "./student-ai-bank.js",
    "./student-ai-cefr-bank.js",
    "./student-ai-local-worker.js",
    "./settings.js",
    "./store.js",
    "./education-admin.js",
    "./manifest.json",
...
/* Define the custom click handler before Firebase Messaging is loaded. */
...
self.addEventListener("fetch", (event) => {
    ...
    if (
        ...
        ["cdn.jsdelivr.net", "cdnjs.cloudflare.com", "www.gstatic.com"].includes(url.hostname)
    ) {
...
messaging.onBackgroundMessage((payload) => {
    ...
    /* Notification messages are displayed automatically by FCM while the
       PWA is in the background. Data-only messages need manual display. */
    ...
    if (notificationId) {
        targetUrl.searchParams.set("student_notification", notificationId);
    }
