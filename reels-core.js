...
(function () {
    ...
    /* تحسين الأداء: تخزين مؤقت للجلسة + مراقبة الظهور */
    let reelsCacheAt = 0;
    const REELS_CACHE_TTL = 45000;
    let reelsRenderedAt = 0;
    let reelsIntersectionObserver = null;
    const REEL_HYDRATE_WINDOW = 1;
    ...
    async function openReels(
        ...
        /* إظهار الواجهة فورًا قبل انتظار البيانات
           إذا ما فيه محتوى محمّل مسبقًا بعد */

        const hasCachedReels =
            !forceRefresh &&
            reels.length &&
            Date.now() - reelsCacheAt <
                REELS_CACHE_TTL;
    ...
    async function loadReels(
        ...
        /* منع تكرار طلب Supabase إذا كانت
           البيانات محمّلة حديثًا (تخزين مؤقت للجلسة) */
    ...
    /* =====================================================
       Scroll / Visibility (IntersectionObserver)
    ===================================================== */
    ...
    function bindScroll() {
        ...
        /* إعادة تشغيل المراقب مع كل render جديد */
                    ...
                    entries.forEach(
                        function (entry) {
                            ...
                            if (
                                ...
                                /* الفيديو خرج تمامًا من الشاشة: أوقفه فورًا */
        ...
        container
            ...
            .forEach(
                function (section) {
                    ...
                    reelsIntersectionObserver.observe(
                        section
                    );
                }
            );
    ...
    /* =====================================================
       تحميل/تفريغ الفيديو (Lazy Loading + Preload ذكي)
    ===================================================== */

    function getReelSection(index) {

        if (!overlay) return null;

        return overlay.querySelector(
            `.student-reel[data-index="${index}"]`
        );
    }

    function hydrateVideoAt(index) {

        const section =
            getReelSection(index);
    ...
    function dehydrateVideoAt(index) {
    ...
    function showEmpty() {
        ...
        container.innerHTML = `
            <div class="student-reels-empty">
                <div style="font-size:18px; font-weight:800;">
                    لا توجد Reels متاحة حاليًا.
                </div>

                <button
                    type="button"
                    class="student-reels-empty-publish"
                    id="student-empty-publish-btn"
                >
                    🎬 انشر أول Reel
                </button>
            </div>
